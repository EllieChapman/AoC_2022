...
main = do
    ...
    -- _bs <- readLinesFromFile "src/day14_input.txt"
    -- print (check 24 (day14_part1 _bs))

    -- putStrLn "*Day 15 Part 1*"
    -- _bs <- readLinesFromFile "src/day15_input.txt"
    -- -- print (check 4582667 (day15_part1 _bs))  -- so slow!!
    -- putStrLn "*Day 15 Part 2*"
    -- print (check 10961118625406 (day15_part2 _bs))

    -- putStrLn "*Day 17 Part 1*"
    -- _bs <- readLinesFromFile "src/day17_input.txt"
    -- print (check 3059 (day17_part1 _bs)) -- real answer
    -- -- print (check 3068 (day17_part1 _bs))
    -- putStrLn "*Day 17 Part 2*"
    -- print (check 1514285714288 (day17_part2 _bs)) -- real answer 1500874635587

    -- putStrLn "*Day 20 Part 1*"
    -- _bs <- readLinesFromFile "src/day20_input.txt"
    -- print (check 4426 (day20_part1 _bs)) -- real answer 4426
    -- -- print (check 3 (day20_part1 _bs))
    -- putStrLn "*Day 20 Part 2*"
    -- print (check 8119137886612 (day20_part2 _bs)) -- real answer 8119137886612
    -- -- print (check 1623178306 (day20_part2 _bs))
